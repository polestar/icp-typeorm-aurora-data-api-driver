...
import { useCleanDatabase } from '../utils/create-connection.ts';
...
describe('aurora data api > simple queries', () => {
  ...
  it('should be able to correctly deal with bulk inserts', async () => {
    await useCleanDatabase('mysql', { entities: [Category] }, async (connection: DataSource) => {
  ...
  it('should handle date/time types', async () => {
    await useCleanDatabase('mysql', { entities: [DateEntity] }, async (connection: DataSource) => {
  ...
  it('should handle json types', async () => {
    await useCleanDatabase('mysql', { entities: [JsonEntity] }, async (connection: DataSource) => {
